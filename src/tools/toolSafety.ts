...
const EXACT_TOOL_ROLES: Readonly<Record<string, ToolSafetyProfile>> = {
  ...
  eos_cue_select: 'programming',
  eos_cuelist_bank_create: 'programming',
  eos_cuelist_bank_page: 'programming',
  eos_magic_sheet_open: 'programming',
  eos_magic_sheet_send_string: 'admin',
  eos_pixmap_select: 'programming',
  eos_curve_select: 'programming',
  eos_toggle_staging_mode: 'programming',
